import { getLast7DaysRange } from "@/app/utils/dateUtils"
...
export default function HeaderBar({
     onSearchChange, onFilterLast7Days, filterActive 
    }: HeaderBarProps) {
    const { startDate, endDate } = getLast7DaysRange()
    const  filterText: string = "Últimos 7 dias";
    return (
        <div> 
            <div className="inline-flex items-center gap-3 mt-5 mb-3 relative w-full ">
                <h1 className="font-poppins font-bold text-3xl text-white">SuperOdds</h1>
                <button >
